	...
	protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!utility.isLoggedin()){
			...
			return;
				...
				System.out.print("SubmitReview additional data:-->"+state+age+gender+occupancy);
		String message=utility.storeReview(productname,producttype,productmaker,reviewrating,reviewdate,reviewtext,retailerpin,productprice,retailercity,state,age,gender,occupancy);	
		...
		pw.print("</h2><div class='entry'>");
      		...
      		pw.print("<h2>Review for &nbsp"+productname1+" Stored </h2>");
                else
