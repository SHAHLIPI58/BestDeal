...
public class Utilities extends HttpServlet{
	...
	public void printHtml(String file) {
		...
		if (file == "Header.html") {
			...
			if (session.getAttribute("username")!=null){
				...
				System.out.println("utilities.java-------------->"+CartCount());
				pw.print(result);
		} else
				pw.print(result);
	}
	...
	public int getOrderPaymentSize(){
		...
		for(Map.Entry<Integer, ArrayList<OrderPayment>> entry : orderPayments.entrySet()){
				size=entry.getKey();
				//System.out.println ("Utilities.java----> getOrderPaymentSize:-->"+size);
		}
	...
	public int CartCount(){
		if(isLoggedin()){
			System.out.println ("Utilities etCustomerOrders().size() --->"+ getCustomerOrders().size());
	...
	public void storePayment(int orderId,
     ...
     public String storeReview(String productname,String producttype,String productmaker,String reviewrating,String reviewdate,
     	String  reviewtext,String reatilerpin,String price,String city, String state,String age, String gender, String occupancy){
	String message=MongoDBDataStoreUtilities.insertReview(productname,username(),producttype,productmaker,reviewrating,reviewdate,
		reviewtext,reatilerpin,price,city,state,age,gender, occupancy);
		...
		Review review = new Review(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,state,age,gender, occupancy);
