	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='consoles' selected>Voiceassistant</option><option value='games'>Watch</option><option value='tablets'>Headphone</option><option value='accessories'>Accessory</option>"
					+"<option value='phones'>Phones</option> <option value='laptops'>Laptops</option> <option value='tvs'>Tvs</option> </select>"
					+ "</td></tr><tr><td>"
		...
		}else if (action.equals("Updateproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					+ "<table id='bestseller'><tr><td>"
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='consoles' selected>Voiceassistant</option><option value='games'>Watch</option><option value='tablets'>Headphone</option><option value='accessories'>Accessory</option>"
					//+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='consoles' selected>Console</option><option value='games'>Games</option><option value='tablets'>Tablet</option><option value='accessories'>Accessory</option>"
					+"<option value='phones'>Phones</option> <option value='laptops'>Laptops</option> <option value='tvs'>Tvs</option> </select>"
					+ "</td></tr><tr><td>"
					+ "<h3>Product Id</h3></td><td><input type='text' name='productId' value='' class='input' required></input>"
					+ "</td></tr><tr><td>"
