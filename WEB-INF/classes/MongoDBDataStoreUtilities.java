...
public static String insertReview(String productname,String username,String producttype,String productmaker,String reviewrating,String reviewdate,
	String reviewtext,String retailerpin,String price,String retailercity,
	String state,String age,String gender,String occupancy)
{
	try
		{		
			//add state,age,gender,occupancy
			getConnection();
...
{	
	...
	while (cursor.hasNext())
	{
		   ...
		   if(!reviews.containsKey(obj.getString("productName")))
			...
			Review review =new Review(obj.getString("productName"),obj.getString("userName"),obj.getString("productType"),obj.getString("productMaker"),
				obj.getString("reviewRating"),obj.getString("reviewDate"),obj.getString("reviewText"),obj.getString("retailerpin"),obj.getString("price"),obj.getString("retailercity"),
				obj.getString("state"),obj.getString("age"),obj.getString("gender"),obj.getString("occupancy"));
